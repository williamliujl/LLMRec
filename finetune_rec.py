...
def train(
    ...
    data_path: str = "data/beauty_sequential_single_prompt_train_sample.json",
    valid_data_path: str = "data/beauty_sequential_single_prompt_test.json",
